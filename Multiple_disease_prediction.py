...
diabetes_model = pickle.load(open(os.path.join(current_dir, 'diabetes_model.sav'), 'rb'))
heart_disease_model = pickle.load(open(os.path.join(current_dir, 'heart_disease_model.sav'), 'rb'))
parkinsons_model = pickle.load(open(os.path.join(current_dir, 'parkinsons_model.sav'), 'rb'))
