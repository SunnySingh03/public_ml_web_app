...
# get the current directory (folder where this .py file is)
current_dir = os.path.dirname(__file__)

# Load all models using relative paths
diabetes_model = pickle.load(open(os.path.join(current_dir, 'traindemodel', 'diabetes_model.sav'), 'rb'))
heart_disease_model = pickle.load(open(os.path.join(current_dir, 'traindemodel', 'heart_disease_model.sav'), 'rb'))
parkinsons_model = pickle.load(open(os.path.join(current_dir, 'traindemodel', 'parkinsons_model.sav'), 'rb'))
